...
const UpdatedDate = ({ setIsDatePicker }) => {
  return (
    <Modal onClickClose={() => setIsDatePicker(false)}>
      <div className="updated-date card">
        <h2 className="updated-date__heading heading-primary">Дата обновления</h2>
        ...
        <button type="submit" className="updated-date__button btn btn--primary mt-6">
          Сохранить
        </button>
      </div>
    </Modal>
