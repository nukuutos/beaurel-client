...
import { parameterServiceSchema } from '../../../../../../../../../../services/utils/schemas';
import useDurationOptions from '../../../../../../../../../../services/hooks/use-duration-options/use-duration-options';
...
const UpdateSubServiceDuration = ({ setStep }) => {
  ...
  const durationOptions = useDurationOptions({ isUpdate: isUpdateSessionTime });
  const schema = parameterServiceSchema(correctSessionTime || 60);
  ...
  return (
    <Formik
      ...
      onSubmit={(values) => {
        dispatch(setAppointmentService({ ...service, duration: values.duration }));
        goToTimetable();
      }}
    >
      {({ values }) => {
