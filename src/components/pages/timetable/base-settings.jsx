  ...
  <Modal isMobileBackground>
    ...
    <div className="timetable-phone-edit-modal">
      ...
      <span className="timetable-card__tip mt-6">
        ...
        {/* generate */}
        <span className="timetable-card__tip--primary">
          {displayPossibleServiceDuration(editingSessionTime)}
        </span>
      </span>
      <button
        onClick={onClickEdit}
      ...
      {element.sessionTime ? (
        ...
        <>
          ...
          {!isDisabled && (
            <div
              onClick={() =>
                setEditState({ isEditing: true, element: { ...editState, sessionTime: true } })
              }
